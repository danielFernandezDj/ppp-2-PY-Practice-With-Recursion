...
# divides both of the integers. For example, look at the numbers 10 and 15: 10 can be
# divided by 1, 5, and 10, 15 can be divided by 1, 3, 5, and 15.
...
# Here is more information on greatest common divisors.
def gcd(a, b):
    while b:
        a, b = b, a % b
    return a
